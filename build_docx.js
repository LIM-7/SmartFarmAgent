...
// ── 附录 A 赛事适配 ──
children.push(heading("附录 A：赛事适配说明（全国范围调研）", 1));
children.push(heading("（一）候选赛事一览", 3));
children.push(table(
  ...
  [2200, 1750, 1900, 2200, 1022],
  [AlignmentType.LEFT, AlignmentType.LEFT, AlignmentType.LEFT, AlignmentType.LEFT, AlignmentType.LEFT]
));
children.push(spacer());

children.push(heading("（二）获奖作品共性启示", 3));
children.push(body("调研近年全国性大赛获奖作品（2026 智慧农业创新大赛、天鹅杯、物联网设计竞赛、挑战杯 AI+、中国国际大学生创新大赛等）可提炼出五条共性："));
children.push(numItem("**真机实操与闭环落地：**2026 智慧农业创新大赛采用实景场地、真机实操，设施小番茄采摘赛道要求在 30 分钟内自主完成行走、识别、定位、采摘与放置，中科院自动化所作品以全程无人工干预、30 分钟采收 75 串获满分 200 分——评审看重「能跑、能干、可量化」。"));
children.push(numItem("**软硬一体化：**物联网设计竞赛一等奖作品（如 AgriMind 智农系统）普遍采用「边缘智能 + 云端协同」，软硬协同优于纯软件方案。"));
children.push(numItem("**大模型/智能体落到执行：**挑战杯 AI+ 一等奖「花语智农」将多模态识别与大模型知识库结合并驱动无人机作业，验证了「大模型到执行器」闭环的评审价值。"));
children.push(numItem("**量化效果与场景验证：**获奖作品普遍给出准确率、效率提升等实测数据，并有真实/仿真场景验证记录（如哈工程「云耕智棚」深耕三年后获红旅赛道金奖）。"));
children.push(numItem("**差异化叙事：**纯软件 RAG 问答已有获奖先例，本作品以「硬件采集 + 大模型决策 + 设备执行」的软硬一体闭环形成差异化，同时保留 RAG 溯源问答能力。"));

children.push(heading("（三）申报策略", 3));
children.push(body("当前无特定参赛目标，建议以「感知—决策—执行闭环能力底座」作为统一叙事，按赛事类型切换侧重点：物联网/嵌入式类强调链路完整性与工程实现；挑战杯/创新大赛强调 AI 应用与社会价值；农业装备类强调装备化改造与作业指标；计算机创新作品赛强调系统完整性与现场演示。交付材料按「作品说明书 + 技术文档 + 演示视频 + 易拉宝 + 承诺书」标准包准备，可按需裁剪。"));

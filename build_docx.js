...
children.push(numItem("**大模型/智能体链路：**司农（南京农业大学，国内首个农业开源大语言模型，8B/32B，魔搭+GitHub 开源）与稷丰 [AgriAgent](https://github.com/zhiweihu1103/AgriAgent)（125★，中文农业多模态）均已核验；[Dify](https://github.com/langgenius/dify) 官方文档确认 HTTP Request 节点可调用外部 API，因此「智能体 → HTTP → MQTT 网关 → 设备」路径可行。"));
children.push(numItem("**云平台链路：**[EMQX](https://github.com/emqx/emqx)（16.5k★）、[Node-RED](https://github.com/node-red/node-red)（23.5k★）、[农业岛](https://github.com/roinli/HUIZHI-nongyeOS-cloud) 智慧农业平台（347★，Java+Vue+Uni-app，支持 MQTT/EMQX）均已核验；[OneNET](https://open.iot.10086.cn) 为中国移动免费物联网平台，教程量大。"));
...
children.push(bullet("[zhujiu39/stm32-flower-greenhouse](https://github.com/zhujiu39/stm32-flower-greenhouse)（2026-06 更新，0★）✅：STM32F103C8T6 花卉温室，OLED+继电器自动控制+ESP8266 MQTT+ThingsCloud，与现有 SmartAgriculture 几乎同构。"));
children.push(bullet("[cz0729zc/smart-orchard-irrigation-system](https://github.com/cz0729zc/smart-orchard-irrigation-system)（26★）✅：STM32+ESP8266 果园灌溉，土壤/光照/温湿度、自动灌溉、驱鸟、LED 补光、APP 远程控制，功能面最全。"));
children.push(bullet("[mcu-coder/stm32_environmental_monitoring](https://github.com/mcu-coder/stm32_environmental_monitoring)（20★）✅：农业大棚环境监测系统（毕业设计案例）。"));
children.push(bullet("[lidonghang-02/greenhouse_control_system](https://github.com/lidonghang-02/greenhouse_control_system)（13★）✅：基于 STM32 的温室控制系统。"));

children.push(heading("6.2 病虫害检测（视觉组）", 3));
children.push(bullet("[pratikkayal/PlantDoc-Dataset](https://github.com/pratikkayal/PlantDoc-Dataset)（427★）✅：PlantDoc 官方数据集仓库（CODS-COMAD 2020 论文配套）。"));
children.push(bullet("PlantVillage 数据集（Kaggle [abdallahalidev/plantvillage-dataset](https://www.kaggle.com/datasets/abdallahalidev/plantvillage-dataset)）✅：5 万+ 叶片图、38 类。"));
children.push(bullet("[ajinkyapawar11/yolov8-crop-disease-monitoring](https://github.com/ajinkyapawar11/yolov8-crop-disease-monitoring)（0★，2025-07 更新）✅：YOLOv8 温室作物病害实时检测（菠菜/生菜/白菜），场景最接近，作架构参考。"));
children.push(bullet("[SHN2004/Plant_Disease_Detection](https://github.com/SHN2004/Plant_Disease_Detection)（9★）✅：ESP32-CAM + 深度学习实时植物病害检测全链路。"));
children.push(bullet("[vishnuskandha/strawberry-disease-detection](https://github.com/vishnuskandha/strawberry-disease-detection)（0★，2026-04 更新）✅：YOLOv8 训练 + Streamlit 应用，工程量最小、最快出结果。"));
children.push(bullet("[Kuipyy/plant-disease-agent](https://github.com/Kuipyy/plant-disease-agent)（0★，2026-07 更新）✅：LLM 编排的病害诊断智能体（分类器 + Grad-CAM 可解释 + RAG 防治建议），与智能体想法直接对口。"));

children.push(heading("6.3 生长状况分析", 3));
children.push(bullet("[Tharinda-Pamindu/Plant-Growth-anaysis-measure-project](https://github.com/Tharinda-Pamindu/Plant-Growth-anaysis-measure-project)（1★）✅：视觉测量叶片数/株高/健康度，正合“自动分析生长状况”。"));
children.push(bullet("[mriglab/GroMo-Plant-Growth-Modeling-with-Multiview-Images](https://github.com/mriglab/GroMo-Plant-Growth-Modeling-with-Multiview-Images)（6★，2026-04 更新）✅：多视角图像生长建模竞赛项目，作进阶参考。"));

children.push(heading("6.4 农业大模型 / 智能体", 3));
children.push(bullet("司农（南京农业大学，2026-01 发布）✅：国内首个农业开源大语言模型，8B/32B，魔搭+GitHub 开源（IT之家、中国农科院官网、新华报业网等多家交叉报道）。"));
children.push(bullet("[zhiweihu1103/AgriAgent](https://github.com/zhiweihu1103/AgriAgent)（稷丰，125★）✅：首个开源中文农业多模态大模型（图像+文本+气象）。"));
children.push(bullet("[csg2008/InternLMAgricultureAssistant](https://github.com/csg2008/InternLMAgricultureAssistant)（3★）✅：书生浦语农业助手——传感器+执行器+大模型自动控制大棚环境，理念最接近的完整参考。"));
children.push(bullet("[nirmal2i43a5/AgriGen](https://github.com/nirmal2i43a5/AgriGen)（0★，2026-02 更新）✅：RAG + Llama 3.3 农业咨询助手。"));
children.push(bullet("[Shuvam-Banerji-Seal/AgriIR](https://github.com/Shuvam-Banerji-Seal/AgriIR)（6★，ECIR'26）✅：农业 RAG 六阶段流水线，检索+引用可溯源。"));
children.push(bullet("[vios-s/PhenoAssistant](https://github.com/vios-s/PhenoAssistant)（35★，2026-07 更新）✅：多智能体植物表型分析系统，智能体架构参考。"));
children.push(bullet("[langgenius/dify](https://github.com/langgenius/dify)（151k★）✅：开源智能体/工作流平台，官方文档确认 HTTP Request 节点可调外部 API（设备控制通道）。"));
children.push(bullet("[infiniflow/ragflow](https://github.com/infiniflow/ragflow)（87k★）✅：开源 RAG 引擎，知识库问答底座。"));
children.push(bullet("[ultralytics/ultralytics](https://github.com/ultralytics/ultralytics)（60k★）✅：YOLOv8/YOLO11 框架。"));

children.push(heading("6.5 云平台 / 小程序 / 可视化", 3));
children.push(bullet("[roinli/HUIZHI-nongyeOS-cloud](https://github.com/roinli/HUIZHI-nongyeOS-cloud)（农业岛，347★）✅：Java+Vue+Uni-app 完整开源农业物联网平台，温棚监控/设备控制/大屏/小程序全有，可二开。"));
children.push(bullet("[CJL-build/-](https://github.com/CJL-build/-)（4★）✅：完整 IoT 项目（Vue 网页+微信小程序+SpringBoot 后端+硬件），含“湿度+温度+光照综合判断自动浇水”逻辑。"));
children.push(bullet("[node-red/node-red](https://github.com/node-red/node-red)（23.5k★）✅：MQTT 数据可视化低代码工具。"));
children.push(bullet("[emqx/emqx](https://github.com/emqx/emqx)（16.5k★）✅：MQTT Broker。"));
children.push(bullet("[OneNET](https://open.iot.10086.cn)（中国移动物联网开放平台）✅：免费云平台，STM32+ESP8266 接入教程量大。"));

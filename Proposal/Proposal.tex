...
\section{项目背景与痛点}
\begin{itemize}
  \item 行业需求真实：青海三江集团（省属国有大型农牧企业，396.86 万亩土地、282 万亩草场、23 万亩青稞油菜基地，年出栏牛羊超 7 万头）已系统规划数字底座、农机调度、粮仓物联网与 AI 智能体等建设内容，规模化智能生产是明确方向。
  \item 方案缺口：企业级智慧农业平台功能完整但重软件集成、成本高；市面常见产品以阈值规则控制为主，大模型应用停留在“知识问答”层，均未把智能决策闭环到设备执行。
  \item 技术窗口：2026 年智慧农业创新大赛六个赛道（智能农机作业控制、无人机巡田、设施采摘机器人、家禽巡检、鱼群检测）集中在“智能体 / IoT + 机器人”方向；农业开源大模型与 RAG 框架成熟可用，硬件成本低，整条链路可以自研。
\end{itemize}

\section{行业对标与项目定位}

本项目不做企业级全平台，而是以低成本硬件原型复现企业方案中最核心、最难落地的“感知—决策—执行”闭环。与青海三江集团智慧农业规划的模块对应关系如下：
...
定位：以 STM32 感知执行端 + 云端大模型智能体，做企业级智慧农业“平台能力的最小可验证原型”，聚焦智能决策到设备动作的完整闭环。
...
\begin{enumerate}
  ...
  \item 智能体链路：司农（国内首个农业开源大语言模型，8B/32B）与 AgriAgent（125 星）均已开源；Dify 官方确认 HTTP 节点可调外部 API，智能体到设备路径可行；青海三江集团规划中同类 AI 智能体（语音填报、RAG 农技问答、病虫害识别）已进入企业建设，技术路线成熟。
...
\begin{enumerate}
  ...
  \item 低成本对标：以低成本硬件原型复现企业级方案（青海三江集团）的核心闭环，教学与科研场景可复制。
